...
func (mw *MDWManager) BrokerAuthedMiddleware() fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx, span := utils.StartFiberTrace(c, "MDWManager.BrokerAuthedMiddleware")
		defer span.End()
		...
		authHeaders := models.AuthHeaders{
			...
			Authorization: c.Cookies(BrokerAccessTokenCookieName),
		}
